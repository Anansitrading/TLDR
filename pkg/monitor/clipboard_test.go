	...
	tests := []struct {
	...
	}{
		{
			...
			contains: []string{
				...
				"### [x] Login page",
				"**ID:** `td-1`",
				"**Type:** task | **Priority:** P1 | **Status:** shipped",
				"#### Description",
				"Main login UI",
				"#### Acceptance Criteria",
...
func TestMarkdownSyntaxValidation(t *testing.T) {
	...
	t.Run("epic markdown syntax", func(t *testing.T) {
		...
		children := []models.Issue{
			{ID: "td-1", Title: "Story 1", Type: models.TypeTask, Status: models.StatusBacklog},
			{ID: "td-2", Title: "Story 2", Type: models.TypeTask, Status: models.StatusShipped},
		}
...
func TestCopyCurrentIssueToClipboard_Epic(t *testing.T) {
	...
	epicTasks := []models.Issue{
		{ID: "td-task-1", Title: "Task 1", Status: models.StatusShipped},
		{ID: "td-task-2", Title: "Task 2", Status: models.StatusBacklog},
	}
